...
| Disruptor Flute      | CardName     | ~bf.etb_choice~      | IR ~Static{CastingCostPlus(3)}~ (+3 cost) & ~Restriction{Activate, mana_exempt}~ (suppress non-mana abilities), both scoped ~Name(It)==ChosenName(Source)~ |
